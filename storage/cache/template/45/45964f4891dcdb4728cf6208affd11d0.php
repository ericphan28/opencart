        ...
        if ((($context["image"] ?? null) || ($context["description"] ?? null))) {
          ...
          ";
            ...
            if (($context["image"] ?? null)) {
                ...
                yield "\" title=\"";
                yield ($context["heading_title"] ?? null);
                yield "\" class=\"img-thumbnail\" style=\"width: 268px\"/></div>
          ";
            }
            // line 16
            yield "          ";
  ...
  <div class=\"row\">{{ column_left }}
    <div id=\"content\" class=\"col\">{{ content_top }}
      ...
      {% if image or description %}
        <div class=\"row\">
          {% if image %}
            <div class=\"col-3\"><img src=\"{{ image }}\" alt=\"{{ heading_title }}\" title=\"{{ heading_title }}\" class=\"img-thumbnail\" style=\"width: 268px\"/></div>
          {% endif %}
          {% if description %}
...
{{ footer }}
", "catalog/view/template/product/category.twig", "D:\\xampp\\htdocs\\opencart\\upload\\catalog\\view\\template\\product\\category.twig");
    }
}
